export const Home = () => {
	return <div className="home-bg">
		...
		<hr className="hline" />
		<image className="image" src="../public/food-waste.png"></image>
		<p className="paragraph">We here at Waste Not Kitchen™ value the community around us. We want to make sure
			 ...
			 in the surrounding area are able to sell their extra plates at a discounted price, allowing them to
			 recoup some losses, but also allowing us to provide a service where people in need are able to eat.</p>
	</div>;
};
